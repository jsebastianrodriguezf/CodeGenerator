...
public class ViewDocDocumentoContactoConfiguration : IEntityTypeConfiguration<ViewDocDocumentoContacto>
{
    public void Configure(EntityTypeBuilder<ViewDocDocumentoContacto> builder)
    {
        builder
            .HasNoKey()
