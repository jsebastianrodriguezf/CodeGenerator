...
public class ViewSynTipoAutenticacionConfiguration : IEntityTypeConfiguration<ViewSynTipoAutenticacion>
{
    public void Configure(EntityTypeBuilder<ViewSynTipoAutenticacion> builder)
    {
        builder
            .HasNoKey()
