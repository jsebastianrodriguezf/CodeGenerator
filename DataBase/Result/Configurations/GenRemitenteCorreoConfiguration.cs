...
public class GenRemitenteCorreoConfiguration : IEntityTypeConfiguration<GenRemitenteCorreo>
{
    public void Configure(EntityTypeBuilder<GenRemitenteCorreo> builder)
    {
        builder.ToTable("gen_remitenteCorreo");

        builder.HasIndex(e => e.Eid, "IX_gen_remitenteCorreo");
