...
public class ViewEquEstadoEquipoConfiguration : IEntityTypeConfiguration<ViewEquEstadoEquipo>
{
    public void Configure(EntityTypeBuilder<ViewEquEstadoEquipo> builder)
    {
        builder
            .HasNoKey()
