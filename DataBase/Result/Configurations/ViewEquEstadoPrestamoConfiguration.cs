...
public class ViewEquEstadoPrestamoConfiguration : IEntityTypeConfiguration<ViewEquEstadoPrestamo>
{
    public void Configure(EntityTypeBuilder<ViewEquEstadoPrestamo> builder)
    {
        builder
            .HasNoKey()
