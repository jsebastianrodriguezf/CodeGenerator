...
public class ViewCatPruebaCheckListAtributoConfiguration : IEntityTypeConfiguration<ViewCatPruebaCheckListAtributo>
{
    public void Configure(EntityTypeBuilder<ViewCatPruebaCheckListAtributo> builder)
    {
        builder
            .HasNoKey()
