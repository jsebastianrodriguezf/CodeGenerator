...
public class ViewDisEstadoEventoConfiguration : IEntityTypeConfiguration<ViewDisEstadoEvento>
{
    public void Configure(EntityTypeBuilder<ViewDisEstadoEvento> builder)
    {
        builder
            .HasNoKey()
