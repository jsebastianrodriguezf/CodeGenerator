...
public class ViewEquCicloHorometroConfiguration : IEntityTypeConfiguration<ViewEquCicloHorometro>
{
    public void Configure(EntityTypeBuilder<ViewEquCicloHorometro> builder)
    {
        builder
            .HasNoKey()
