...
public class ViewCntContratoDetalleVisitumConfiguration : IEntityTypeConfiguration<ViewCntContratoDetalleVisitum>
{
    public void Configure(EntityTypeBuilder<ViewCntContratoDetalleVisitum> builder)
    {
        builder
            .HasNoKey()
