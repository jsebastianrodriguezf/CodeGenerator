...
public class GenTipoServicioConfiguration : IEntityTypeConfiguration<GenTipoServicio>
{
    public void Configure(EntityTypeBuilder<GenTipoServicio> builder)
    {
        builder.ToTable("gen_tipoServicio");

        builder.HasIndex(e => e.Eid, "IX_gen_tipoServicio");
