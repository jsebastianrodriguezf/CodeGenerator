...
public class ViewDocDocumentoOtPruebaCheckListConfiguration : IEntityTypeConfiguration<ViewDocDocumentoOtPruebaCheckList>
{
    public void Configure(EntityTypeBuilder<ViewDocDocumentoOtPruebaCheckList> builder)
    {
        builder
            .HasNoKey()
