...
public class ViewDocPendienteDocumentoDocItemDocumentoConfiguration : IEntityTypeConfiguration<ViewDocPendienteDocumentoDocItemDocumento>
{
    public void Configure(EntityTypeBuilder<ViewDocPendienteDocumentoDocItemDocumento> builder)
    {
        builder
            .HasNoKey()
        ...
        builder.Property(e => e.DocPendienteDocumentoCantidad).HasColumnName("doc_pendienteDocumento_cantidad");
        builder.Property(e => e.DocPendienteDocumentoIdCatalogo).HasColumnName("doc_pendienteDocumento_id_catalogo");
        builder.Property(e => e.DocPendienteDocumentoIdDocumento).HasColumnName("doc_pendienteDocumento_id_documento");
        builder.Property(e => e.DocPendienteDocumentoIdReporteTecnico).HasColumnName("doc_pendienteDocumento_id_reporteTecnico");
        builder.Property(e => e.DocPendienteDocumentoIdTipoDocumento).HasColumnName("doc_pendienteDocumento_id_tipoDocumento");
        builder.Property(e => e.DocPendienteDocumentoOlvidar).HasColumnName("doc_pendienteDocumento_olvidar");
        builder.Property(e => e.DocPendienteDocumentoPendienteDocumento)
            .HasMaxLength(300)
            .IsUnicode(false)
            .HasColumnName("doc_pendienteDocumento_pendienteDocumento");
        builder.Property(e => e.DocPendienteDocumentoPendienteDocumentoCodigo)
            .HasMaxLength(100)
            .IsUnicode(false)
