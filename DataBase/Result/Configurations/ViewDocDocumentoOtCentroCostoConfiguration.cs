...
public class ViewDocDocumentoOtCentroCostoConfiguration : IEntityTypeConfiguration<ViewDocDocumentoOtCentroCosto>
{
    public void Configure(EntityTypeBuilder<ViewDocDocumentoOtCentroCosto> builder)
    {
        builder
            .HasNoKey()
