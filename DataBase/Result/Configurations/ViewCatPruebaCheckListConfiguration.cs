...
public class ViewCatPruebaCheckListConfiguration : IEntityTypeConfiguration<ViewCatPruebaCheckList>
{
    public void Configure(EntityTypeBuilder<ViewCatPruebaCheckList> builder)
    {
        builder
            .HasNoKey()
