...
public class ViewTerSucursalListaprecioConfiguration : IEntityTypeConfiguration<ViewTerSucursalListaprecio>
{
    public void Configure(EntityTypeBuilder<ViewTerSucursalListaprecio> builder)
    {
        builder
            .HasNoKey()
