...
public class ViewGenConfiguracionServicioConfiguration : IEntityTypeConfiguration<ViewGenConfiguracionServicio>
{
    public void Configure(EntityTypeBuilder<ViewGenConfiguracionServicio> builder)
    {
        builder
            .HasNoKey()
