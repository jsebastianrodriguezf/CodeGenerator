...
public class ViewRepTipoCampoReporteConfiguration : IEntityTypeConfiguration<ViewRepTipoCampoReporte>
{
    public void Configure(EntityTypeBuilder<ViewRepTipoCampoReporte> builder)
    {
        builder
            .HasNoKey()
