...
public class ViewGenArchivoConfiguration : IEntityTypeConfiguration<ViewGenArchivo>
{
    public void Configure(EntityTypeBuilder<ViewGenArchivo> builder)
    {
        builder
            .HasNoKey()
        ...
        builder.Property(e => e.Eid)
            ...
            .IsUnicode(false)
            .HasColumnName("eid");
        builder.Property(e => e.EsPrincipal).HasColumnName("esPrincipal");
        ...
        builder.Property(e => e.GenTipoArchivoTipoArchivo)
            .HasMaxLength(300)
            .IsUnicode(false)
            .HasColumnName("gen_tipoArchivo_tipoArchivo");
        builder.Property(e => e.GenTipoArchivoTipoArchivoCodigo)
            .HasMaxLength(100)
            .IsUnicode(false)
