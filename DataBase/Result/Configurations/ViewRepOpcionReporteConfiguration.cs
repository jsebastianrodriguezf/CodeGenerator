...
public class ViewRepOpcionReporteConfiguration : IEntityTypeConfiguration<ViewRepOpcionReporte>
{
    public void Configure(EntityTypeBuilder<ViewRepOpcionReporte> builder)
    {
        builder
            .HasNoKey()
