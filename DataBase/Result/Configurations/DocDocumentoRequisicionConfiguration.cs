...
public class DocDocumentoRequisicionConfiguration : IEntityTypeConfiguration<DocDocumentoRequisicion>
{
    public void Configure(EntityTypeBuilder<DocDocumentoRequisicion> builder)
    {
        builder.HasKey(e => e.Id).HasName("PK_doc_documento_requisicion");

        builder.ToTable("doc_documento.requisicion");

        builder.HasIndex(e => e.Eid, "IX_doc_documento_requisicion");
        ...
        builder.HasOne(d => d.IdSucursalNavigation).WithMany(p => p.DocDocumentoRequisicions)
