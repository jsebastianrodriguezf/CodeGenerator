...
public class ViewCntTipoContratoConfiguration : IEntityTypeConfiguration<ViewCntTipoContrato>
{
    public void Configure(EntityTypeBuilder<ViewCntTipoContrato> builder)
    {
        builder
            .HasNoKey()
