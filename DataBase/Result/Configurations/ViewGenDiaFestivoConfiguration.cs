...
public class ViewGenDiaFestivoConfiguration : IEntityTypeConfiguration<ViewGenDiaFestivo>
{
    public void Configure(EntityTypeBuilder<ViewGenDiaFestivo> builder)
    {
        builder
            .HasNoKey()
