...
public class ViewDocDocumentoProyectoCalidadConfiguration : IEntityTypeConfiguration<ViewDocDocumentoProyectoCalidad>
{
    public void Configure(EntityTypeBuilder<ViewDocDocumentoProyectoCalidad> builder)
    {
        builder
            .HasNoKey()
        ...
        builder.Property(e => e.ProCalidadCalidad)
            .HasMaxLength(300)
            .IsUnicode(false)
            .HasColumnName("pro_calidad_calidad");
        builder.Property(e => e.ProCalidadCalidadCodigo)
            .HasMaxLength(100)
            .IsUnicode(false)
