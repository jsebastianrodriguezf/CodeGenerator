...
public class ViewGenBodegaUsuarioConfiguration : IEntityTypeConfiguration<ViewGenBodegaUsuario>
{
    public void Configure(EntityTypeBuilder<ViewGenBodegaUsuario> builder)
    {
        builder
            .HasNoKey()
