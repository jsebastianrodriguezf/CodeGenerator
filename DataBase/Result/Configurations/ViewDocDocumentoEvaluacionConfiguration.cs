...
public class ViewDocDocumentoEvaluacionConfiguration : IEntityTypeConfiguration<ViewDocDocumentoEvaluacion>
{
    public void Configure(EntityTypeBuilder<ViewDocDocumentoEvaluacion> builder)
    {
        builder
            .HasNoKey()
