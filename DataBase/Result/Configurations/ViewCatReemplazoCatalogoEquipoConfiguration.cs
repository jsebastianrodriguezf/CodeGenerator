...
public class ViewCatReemplazoCatalogoEquipoConfiguration : IEntityTypeConfiguration<ViewCatReemplazoCatalogoEquipo>
{
    public void Configure(EntityTypeBuilder<ViewCatReemplazoCatalogoEquipo> builder)
    {
        builder
            .HasNoKey()
        ...
        builder.Property(e => e.CatReemplazoIdCatalogoRepuesto).HasColumnName("cat_reemplazo_id_catalogo.repuesto");
        builder.Property(e => e.CatReemplazoIdCatalogoRepuesto1).HasColumnName("cat_reemplazo_id_catalogo.repuesto_1");
        builder.Property(e => e.CatReemplazoIdTipoReemplazo).HasColumnName("cat_reemplazo_id_tipoReemplazo");
        builder.Property(e => e.CatReemplazoReemplazo)
            .HasMaxLength(300)
            .IsUnicode(false)
            .HasColumnName("cat_reemplazo_reemplazo");
        builder.Property(e => e.CatReemplazoReemplazoCodigo)
            .HasMaxLength(100)
            .IsUnicode(false)
