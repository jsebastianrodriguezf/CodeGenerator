...
public class ViewProActividadEjecutorConfiguration : IEntityTypeConfiguration<ViewProActividadEjecutor>
{
    public void Configure(EntityTypeBuilder<ViewProActividadEjecutor> builder)
    {
        builder
            .HasNoKey()
