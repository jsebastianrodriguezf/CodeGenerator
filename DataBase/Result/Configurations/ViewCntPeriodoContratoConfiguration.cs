...
public class ViewCntPeriodoContratoConfiguration : IEntityTypeConfiguration<ViewCntPeriodoContrato>
{
    public void Configure(EntityTypeBuilder<ViewCntPeriodoContrato> builder)
    {
        builder
            .HasNoKey()
