...
public class ViewSynCampoIntegracionConfiguration : IEntityTypeConfiguration<ViewSynCampoIntegracion>
{
    public void Configure(EntityTypeBuilder<ViewSynCampoIntegracion> builder)
    {
        builder
            .HasNoKey()
        ...
        builder.Property(e => e.Eid)
            ...
            .IsUnicode(false)
            .HasColumnName("eid");
        builder.Property(e => e.EsLlave).HasColumnName("esLlave");
        ...
        builder.Property(e => e.TipoDato).HasColumnName("tipoDato");
