...
public class ViewOrtCanalAtencionConfiguration : IEntityTypeConfiguration<ViewOrtCanalAtencion>
{
    public void Configure(EntityTypeBuilder<ViewOrtCanalAtencion> builder)
    {
        builder
            .HasNoKey()
