...
public class ViewCatVersionEquipoConfiguration : IEntityTypeConfiguration<ViewCatVersionEquipo>
{
    public void Configure(EntityTypeBuilder<ViewCatVersionEquipo> builder)
    {
        builder
            .HasNoKey()
