...
public class ViewDocTipoDocumentoConfiguration : IEntityTypeConfiguration<ViewDocTipoDocumento>
{
    public void Configure(EntityTypeBuilder<ViewDocTipoDocumento> builder)
    {
        builder
            .HasNoKey()
        ...
        builder.Property(e => e.PuedeSerMayor).HasColumnName("puedeSerMayor");
        builder.Property(e => e.PuedeSerMenor).HasColumnName("puedeSerMenor");
