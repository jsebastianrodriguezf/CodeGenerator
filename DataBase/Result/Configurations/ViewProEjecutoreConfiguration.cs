...
public class ViewProEjecutoreConfiguration : IEntityTypeConfiguration<ViewProEjecutore>
{
    public void Configure(EntityTypeBuilder<ViewProEjecutore> builder)
    {
        builder
            .HasNoKey()
        ...
        builder.Property(e => e.ProHorarioEjecutoresHorarioEjecutores)
            .HasMaxLength(300)
            .IsUnicode(false)
            .HasColumnName("pro_horarioEjecutores_horarioEjecutores");
        builder.Property(e => e.ProHorarioEjecutoresHorarioEjecutoresCodigo)
            .HasMaxLength(100)
            .IsUnicode(false)
