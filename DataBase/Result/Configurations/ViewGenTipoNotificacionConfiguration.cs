...
public class ViewGenTipoNotificacionConfiguration : IEntityTypeConfiguration<ViewGenTipoNotificacion>
{
    public void Configure(EntityTypeBuilder<ViewGenTipoNotificacion> builder)
    {
        builder
            .HasNoKey()
