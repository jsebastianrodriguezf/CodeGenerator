...
public class ViewTerContactoConfiguration : IEntityTypeConfiguration<ViewTerContacto>
{
    public void Configure(EntityTypeBuilder<ViewTerContacto> builder)
    {
        builder
            .HasNoKey()
        ...
        builder.Property(e => e.TerCargoContactoCargoContacto)
            .HasMaxLength(300)
            .IsUnicode(false)
            .HasColumnName("ter_cargoContacto_cargoContacto");
        builder.Property(e => e.TerCargoContactoCargoContactoCodigo)
            .HasMaxLength(100)
            .IsUnicode(false)
