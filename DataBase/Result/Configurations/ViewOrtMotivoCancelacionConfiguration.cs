...
public class ViewOrtMotivoCancelacionConfiguration : IEntityTypeConfiguration<ViewOrtMotivoCancelacion>
{
    public void Configure(EntityTypeBuilder<ViewOrtMotivoCancelacion> builder)
    {
        builder
            .HasNoKey()
