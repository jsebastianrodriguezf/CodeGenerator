...
public class ViewTerNaturalezaTerceroConfiguration : IEntityTypeConfiguration<ViewTerNaturalezaTercero>
{
    public void Configure(EntityTypeBuilder<ViewTerNaturalezaTercero> builder)
    {
        builder
            .HasNoKey()
