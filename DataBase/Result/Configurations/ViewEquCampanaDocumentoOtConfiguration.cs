...
public class ViewEquCampanaDocumentoOtConfiguration : IEntityTypeConfiguration<ViewEquCampanaDocumentoOt>
{
    public void Configure(EntityTypeBuilder<ViewEquCampanaDocumentoOt> builder)
    {
        builder
            .HasNoKey()
        ...
        builder.Property(e => e.Eid)
            ...
            .IsUnicode(false)
            .HasColumnName("eid");
        builder.Property(e => e.EquCampanaActivo).HasColumnName("equ_campana_activo");
        builder.Property(e => e.EquCampanaCampana)
            .HasMaxLength(300)
            .IsUnicode(false)
            .HasColumnName("equ_campana_campana");
        builder.Property(e => e.EquCampanaCampanaCodigo)
            .HasMaxLength(100)
            .IsUnicode(false)
            .HasColumnName("equ_campana_campana_codigo");
        builder.Property(e => e.EquCampanaDetalleCampana)
            .HasMaxLength(8000)
            .IsUnicode(false)
            .HasColumnName("equ_campana_detalleCampana");
        builder.Property(e => e.EquCampanaFechaInicioFf)
            .HasColumnType("smalldatetime")
            .HasColumnName("equ_campana_fechaInicio_ff");
        builder.Property(e => e.EquCampanaFechafinFf)
            .HasColumnType("smalldatetime")
            .HasColumnName("equ_campana_fechafin_ff");
        builder.Property(e => e.EquCampanaIdCatalogoTempario).HasColumnName("equ_campana_id_catalogo.tempario");
        builder.Property(e => e.EquCampanaIdTercero).HasColumnName("equ_campana_id_tercero");
