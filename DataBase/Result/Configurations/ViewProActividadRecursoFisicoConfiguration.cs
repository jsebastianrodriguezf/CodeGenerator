...
public class ViewProActividadRecursoFisicoConfiguration : IEntityTypeConfiguration<ViewProActividadRecursoFisico>
{
    public void Configure(EntityTypeBuilder<ViewProActividadRecursoFisico> builder)
    {
        builder
            .HasNoKey()
        ...
        builder.Property(e => e.ProRecursoFisicoCosto).HasColumnName("pro_recursoFisico_costo");
        builder.Property(e => e.ProRecursoFisicoEsPropio).HasColumnName("pro_recursoFisico_esPropio");
        builder.Property(e => e.ProRecursoFisicoIdCatalogo).HasColumnName("pro_recursoFisico_id_catalogo");
        builder.Property(e => e.ProRecursoFisicoIdEquipo).HasColumnName("pro_recursoFisico_id_equipo");
        builder.Property(e => e.ProRecursoFisicoRecursoFisico)
            .HasMaxLength(300)
            .IsUnicode(false)
            .HasColumnName("pro_recursoFisico_recursoFisico");
        builder.Property(e => e.ProRecursoFisicoRecursoFisicoCodigo)
            .HasMaxLength(100)
            .IsUnicode(false)
            .HasColumnName("pro_recursoFisico_recursoFisico_codigo");
        builder.Property(e => e.ProRecursoFisicoUnidadTiempo)
            .HasMaxLength(1)
            .IsUnicode(false)
