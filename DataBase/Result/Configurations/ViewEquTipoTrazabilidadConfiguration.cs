...
public class ViewEquTipoTrazabilidadConfiguration : IEntityTypeConfiguration<ViewEquTipoTrazabilidad>
{
    public void Configure(EntityTypeBuilder<ViewEquTipoTrazabilidad> builder)
    {
        builder
            .HasNoKey()
