...
public class ViewCatTipoCatalogoConfiguration : IEntityTypeConfiguration<ViewCatTipoCatalogo>
{
    public void Configure(EntityTypeBuilder<ViewCatTipoCatalogo> builder)
    {
        builder
            .HasNoKey()
