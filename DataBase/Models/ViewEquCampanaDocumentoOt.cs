...
public partial class ViewEquCampanaDocumentoOt
{
    ...
    public string EquCampanaCampana { get; set; } = null!;

    public string? EquCampanaCampanaCodigo { get; set; }

    public string EquCampanaDetalleCampana { get; set; } = null!;

    public DateTime EquCampanaFechaInicioFf { get; set; }

    public DateTime EquCampanaFechafinFf { get; set; }

    public bool EquCampanaActivo { get; set; }

    public int EquCampanaIdTercero { get; set; }

    public int EquCampanaIdCatalogoTempario { get; set; }
