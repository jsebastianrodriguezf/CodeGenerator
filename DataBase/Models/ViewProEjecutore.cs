...
public partial class ViewProEjecutore
{
    ...
    public string ProHorarioEjecutoresHorarioEjecutores { get; set; } = null!;

    public string? ProHorarioEjecutoresHorarioEjecutoresCodigo { get; set; }
