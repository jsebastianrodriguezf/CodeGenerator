...
public partial class ViewOrtReporteTecnico
{
    ...
    public string OrtCanalAtencionCanalAtencion { get; set; } = null!;

    public string? OrtCanalAtencionCanalAtencionCodigo { get; set; }
    ...
    public int DocDocumentoGastoIdUsuarioSolicitante { get; set; }
